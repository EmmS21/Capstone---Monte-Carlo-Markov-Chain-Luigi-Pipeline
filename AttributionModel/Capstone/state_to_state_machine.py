...
class state_machine(luigi.Task):
    ...
    def run(self):
        ...
        output_df.to_csv('C:\\Users\\User\\Documents\\GitHub\\Springboard-DSC\\AttributionModel\\Data\\sims\\'+str(self.obs_nums)+'statemachine.csv')
    def requires(self):
    ...
    def output(self):
        return luigi.LocalTarget('C:\\Users\\User\\Documents\\GitHub\\Springboard-DSC\\AttributionModel\\Data\\sims\\'+str(self.obs_nums)+'statemachine.csv')
